...
import pl.kuba565.resttask.jooq.tables.records.DatabasechangelogRecord;
...
public class Databasechangelog extends TableImpl<DatabasechangelogRecord> {
    ...
    private static final long serialVersionUID = -1592817344;
     ...
     */
    public final TableField<DatabasechangelogRecord, Timestamp> DATEEXECUTED = createField(DSL.name("DATEEXECUTED"), org.jooq.impl.SQLDataType.TIMESTAMP.precision(6).nullable(false), this, "");
